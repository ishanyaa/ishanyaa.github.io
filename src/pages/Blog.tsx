  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="space-y-6">
          {posts.slice(1).map((post, index) => (
            <article key={index} className="terminal-card card-hover">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    {post.status === 'draft' && (
                      <span className="text-xs bg-yellow-500/10 text-yellow-400 px-2 py-1 rounded-md">
                        Draft
                      </span>
                    )}
                  </div>
      ...
      <section className="terminal-card text-center">
        <h2 className="text-2xl font-bold mb-4 glow-text">Stay Updated</h2>
        <p className="text-muted-foreground mb-6">
          Get notified when I publish new posts about AI research, coding adventures, 
        ...
        <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
          ...
          />
          <button className="btn-terminal whitespace-nowrap">
            Subscribe
          </button>
        </div>
