  ...
  const posts: Record<string, Post> = {
    ...
    'accessibility-iit-delhi': {
      ...
      sections: [
        ...
        { type: 'text', content: "Under the guidance of [Dr. Piyush Chanana](https://ieeexplore.ieee.org/author/37085991635) and Dr. Anupama J, we worked on:" },
        { type: 'list', items: [
        ...
        { type: 'text', content: "The hardest part wasn't the technology. It was understanding the users. We ran user studies with visually impaired students, and their feedback taught us more than any paper could." },
